...
### Testing for File Read via SSRF
...
### The Malicious Flask Backend Server
...
### DNS Poisoning Attack - MX Record Hijacking
...
### SMTP Server Setup and Email Interception
...
### Sending Phishing Emails with swaks
...
### AI Assistant Exploitation - Prompt Injection
...
## Stage 4: Internal Network Pivot and Ollama API
...
### Extracting Model System Prompt
